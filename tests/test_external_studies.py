...
from fedfalsify.external_srsd_study import PROBLEMS, _clients, _with_dummies
from fedfalsify.external_srsd_study_fixed import build_catalog as build_srsd_catalog
...
def test_srsd_misspecified_catalog_excludes_truth_and_keeps_dummies() -> None:
    ...
    scaling = fit_standardization([ExternalClientData("a", x[:40], y[:40]), ExternalClientData("b", x[40:], y[40:])])
